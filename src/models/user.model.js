...
userSchema.pre("save", async function(){        // to encrypt before saving we use this pre hook from (mongoose middleware)
    if(!this.isModified("password")) return  // ismodified is built-in methods
